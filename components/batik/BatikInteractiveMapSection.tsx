    ...
    <section className="bg-[#f9f1e4] py-16 px-6 md:px-12 lg:px-24">
      <div className="mx-auto w-full max-w-[var(--container-lg)] flex flex-col gap-8">
        ...
        <div className="relative w-full max-w-[1000px] aspect-[16/5] mx-auto mt-8 mb-8">
          ...
          <Link
            href="/batik"
            className="absolute top-[3%] left-[8%] w-[28%] aspect-[6/3] cursor-pointer hover:-translate-y-2 hover:scale-105 transition-all duration-300 origin-bottom z-20 drop-shadow-2xl group flex flex-col items-center"
          >
