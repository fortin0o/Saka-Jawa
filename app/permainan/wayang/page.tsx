...
export default function WayangGamePage() {
  return (
    <GameLayout
      title="Dunia Pewayangan Jawa"
      subtitle="Tebak tokoh, cerita, dan jenis wayang khas dari budaya pewayangan Jawa."
      pendhapa="wayang"
      nextHref="/permainan/gamelan"
      nextLabel="Lanjut ke Gamelan"
    >
      ...
      <div className="flex flex-col items-center justify-center min-h-[300px] sm:min-h-[360px] rounded-xl sm:rounded-2xl border-2 border-dashed border-[#4E0B11]/30 bg-white/60 p-6 sm:p-10 text-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#4A332B] font-medium mt-1.5 max-w-xs mx-auto leading-relaxed">
            Area permainan akan dibangun di sini. Kenali tokoh-tokoh wayang
            legendaris tanah Jawa!
          </p>
        </div>
