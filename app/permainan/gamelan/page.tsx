        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 py-4">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-md gap-4">
            ...
            <ul className="text-sm text-[#4A332B] leading-relaxed space-y-2 bg-white border border-[#4E0B11]/20 rounded-xl p-4 shadow-sm w-full text-left">
              ...
              <li className="flex gap-2"><span className="text-[#FFC832] font-bold shrink-0">5.</span>Capai ronde ke-4 untuk membuka Pendhapa Kuliner!</li>
            </ul>
      ...
      <div className="flex flex-col gap-4">
        ...
        {round <= MIN_ROUND_TO_WIN && (
          <p className="text-center text-[10px] text-[#4A332B]/60 font-medium">
            Target: selesaikan hingga ronde <strong className="text-[#4E0B11]">{MIN_ROUND_TO_WIN}</strong> untuk membuka Pendhapa Kuliner
          </p>
        )}
        {round > MIN_ROUND_TO_WIN && (
