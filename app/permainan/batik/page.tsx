...
export default function BatikGamePage() {
  return (
    <GameLayout
      title="Kenali Motif Batik Jawa"
      subtitle="Uji pengetahuanmu tentang ragam motif batik khas dari berbagai penjuru tanah Jawa."
      pendhapa="batik"
      nextHref="/permainan/wayang"
      nextLabel="Lanjut ke Wayang"
    >
      ...
      <div className="flex flex-col items-center justify-center min-h-[300px] sm:min-h-[360px] rounded-xl sm:rounded-2xl border-2 border-dashed border-[#4E0B11]/30 bg-white/60 p-6 sm:p-10 text-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#4A332B] font-medium mt-1.5 max-w-xs mx-auto leading-relaxed">
            Area permainan akan dibangun di sini. Pasangkan motif batik dengan
            daerah asalnya!
          </p>
        </div>
